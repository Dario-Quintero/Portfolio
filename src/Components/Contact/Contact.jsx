...
function Contact() {
  ...
  return (
    <div className="flex flex-wrap-reverse items-center justify-between w-full mt-1">
      <div className="flex gap-2 justify-evenly font-normal">
        <button onClick={handleEmail} className="dropdown dropdown-bottom">
          <div
            tabIndex={0}
            role="button"
            className="flex gap-2 items-center justify-center p-1 max-w-[100px] px-2 bg-black/15 text-black/90 hover:scale-105 dark:bg-white/20 dark:text-white/65"
          >
            <svg
          ...
          <ul
            tabIndex={0}
            className="dropdown-content z-[1] mt-1 menu p-0 md:p-2 w-20 md:w-44 bg-black/15 text-black/60 "
          >
            <li>
      ...
      <p className="right-0 w-full pr-2 m-1 mt-0 font-bold md:w-auto md:m-0 text-end text-black dark:text-white ">
        Córdoba, Argentina
      </p>
    </div>
  );
